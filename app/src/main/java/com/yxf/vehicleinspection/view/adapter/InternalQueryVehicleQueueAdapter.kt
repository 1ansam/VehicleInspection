 ...
 *   time:2021/10/18
 */
class InternalQueryVehicleQueueAdapter : BaseRvAdapter<VehicleQueueResponse, VehicleQueueItemBinding>() {
    ...
    override fun onBindViewHolder(
        ...
        holder.itemView.setOnClickListener {
            ...
            it.findNavController().navigate(R.id.internalQueryItemFragment,bundle)
        }
    }
}