 ...
 *   time:2021/10/18
 */
class UniqueCheckVehicleQueueAdapter : BaseRvAdapter<VehicleQueueResponse, VehicleQueueItemBinding>() {
    ...
    override fun onBindViewHolder(
        ...
        holder.itemView.setOnClickListener {
            ...
            it.findNavController().navigate(R.id.uniqueCheckItemFragment,bundle)
        }
    }
}